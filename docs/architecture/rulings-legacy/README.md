# Legacy Rulings Snapshot

> Archived normative snapshot created by PR-0400.
> This directory preserves the pre-ADR governance baseline as historical reference.
> It is not the current-effective rulings registry after governance activation.
> Rebuilt rulings belong under `docs/architecture/rulings/`.
