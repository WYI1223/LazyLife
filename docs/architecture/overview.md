...
- `docs/architecture/rulings/README.md` — current-effective rebuilt rulings registry
- `docs/architecture/rulings-legacy/README.md` — archived S1-S9 semantic rulings snapshot
