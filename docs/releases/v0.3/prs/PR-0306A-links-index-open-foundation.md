# PR-0306A-links-index-open-foundation

- Proposed title: `feat(links): links extraction/index and safe open foundation (Windows first)`
- Status: Planned

## Goal

Deliver links parsing/indexing and safe-open baseline required by workspace launcher flows.
...
- FFI exposure for links list/search/open use-cases

Out of scope:

- workspace launcher `Open All` orchestration (handled by `PR-0307`)
- multi-platform open parity beyond current baseline
- advanced custom scheme whitelist

## Dependency

- predecessor for `PR-0307-workspace-launcher-experience`
- source migration from deferred `PR-0212-links-index-open-v1`
...
- [edit] `docs/research/todo_Link&Workspace_Launcher.md`
