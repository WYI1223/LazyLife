...
- [ ] `docs/reports/v0.4/governance-execution/` 目录结构已创建（含 README 与 PR-0400~06 子目录）
...
- [DI-20-governance-execution-plan.md](../design-discussions/DI-20-governance-execution-plan.md)（T0 定义与 PR-0400 gate）
