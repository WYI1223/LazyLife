...
1. 修改 PR-GOV-01 已完成的 extraction 字段
2. 修改 PR-GOV-02 已定稿的元数据合同
3. Repo-wide 一致性审计（由 PR-GOV-04 负责）
4. Theme Delta Contract 模型定稿（由 PR-GOV-04 负责）
...
- [ ] 每篇已产出的 ADR 符合 PR-GOV-02 定稿的元数据合同
