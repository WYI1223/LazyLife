...
| `C07` | `2026-03-01 / E1` | Normative Source | `docs/architecture/rulings/E1-release-and-versioning.md` | `引入版本`, `迁移来源`, `修订历史` | 提供发布与版本策略的当前规范锚点，并记录 ADR-0001 迁移来源 | `TH-006`, `TH-007` | 当前 corpus 中唯一直接纳入的规范源 |
