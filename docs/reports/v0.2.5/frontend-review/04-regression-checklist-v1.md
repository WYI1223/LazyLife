...
| 测试基线 | `flutter test` 321 pass / 0 known-fail（当前）；首次完整回归为 316 pass / 0 known-fail（P0-5） |
| 版本 | v1 |
| 更新日期 | 2026-02-25 |
...
|------|---------|--------|---------|---------|
| Phase 0 | 2026-02-24 | TL + Agent | REG-01~03, REG-05~10 通过；REG-04 已知偏差（非阻塞） | - |
| Phase 1 | 待执行 | 待填写 | 待填写 | - |
| Phase 2 | 待执行 | 待填写 | 待填写 | - |
| Phase 3 | 待执行 | 待填写 | 待填写 | - |
...
|---------|------------------|------|---------|
| REG-01 | 通过 | P0-5 首次全量回归记录 | - |
| REG-02 | 通过 | P0-5 首次全量回归记录 | - |
| REG-03 | 通过 | P0-5 首次全量回归记录 | - |
| REG-04 | 已知偏差（非阻塞） | 语义未完全对齐；非 P0-5 修复范围 | - |
| REG-05 | 通过 | P0-5 首次全量回归记录 | - |
| REG-06 | 通过 | P0-5 首次全量回归记录 | - |
| REG-07 | 通过 | P0-5 首次全量回归记录 | - |
| REG-08 | 通过 | P0-5 首次全量回归记录 | - |
| REG-09 | 通过 | P0-5 首次全量回归记录 | - |
| REG-10 | 通过 | P0-5 首次全量回归记录 | - |
