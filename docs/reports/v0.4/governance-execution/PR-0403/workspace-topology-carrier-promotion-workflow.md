...
| `execution-order` | `PR-0408` through `PR-0413` | `partial` | `docs/releases/v0.4/prs/PR-0408-schema-migration.md`; `docs/releases/v0.4/prs/PR-0409-scoped-query-repository.md`; `docs/releases/v0.4/prs/PR-0410-tree-service-creation-service.md`; `crates/lazynote_core/src/db/migrations/mod.rs`; `crates/lazynote_core/src/repo/scoped_query_repo.rs`; `crates/lazynote_core/src/service/task_service.rs`; `crates/lazynote_core/src/service/creation_service.rs`; `crates/lazynote_core/tests/migration_0012_test.rs`; `crates/lazynote_core/tests/scoped_query_repo.rs`; `crates/lazynote_core/tests/creation_service_routing.rs` | `PR-0408` migration-first prerequisite is landed, `PR-0409` lands the scoped-query slice with an explicit compatibility bridge, and `PR-0410` now consumes that bridge by making new writes designated-folder only while preserving legacy root-scoped read compatibility; later PR dependencies remain pending |
...
| `verification-gates` | `PR-0408` through `PR-0413` | `partial` | `crates/lazynote_core/tests/migration_0012_test.rs`; `crates/lazynote_core/tests/workspace_tree.rs`; `crates/lazynote_core/tests/db_migrations.rs`; `crates/lazynote_core/tests/scoped_query_repo.rs`; `crates/lazynote_core/tests/time_matrix.rs`; `crates/lazynote_core/tests/creation_service_routing.rs`; `crates/lazynote_ffi/src/api.rs` | `PR-0408` migration/install/upgrade/guard/workspace-compat verification remains landed, `PR-0409` adds scoped-query truth-table coverage and time-matrix bridge coverage, and `PR-0410` now adds canonical path/ref-location, service protection, designated reassign, and creation-routing tests; later PR-specific FFI/Flutter gates remain pending |
