...
| `execution-order` | `PR-0408` through `PR-0413` | `partial` | `docs/releases/v0.4/prs/PR-0408-schema-migration.md`; `docs/releases/v0.4/prs/PR-0409-scoped-query-repository.md`; `docs/releases/v0.4/prs/PR-0410-tree-service-creation-service.md`; `docs/releases/v0.4/prs/PR-0411-guard-ffi.md`; `crates/lazynote_core/src/db/migrations/mod.rs`; `crates/lazynote_core/src/repo/scoped_query_repo.rs`; `crates/lazynote_core/src/service/creation_service.rs`; `crates/lazynote_core/src/guard/mod.rs`; `crates/lazynote_ffi/src/api.rs` | `PR-0408` migration-first prerequisite is landed, `PR-0409` lands the scoped-query slice with an explicit compatibility bridge, `PR-0410` consumes that bridge for canonical creation/tree routing, and `PR-0411` now layers guarded FFI on top without reopening schema/service contracts; later Flutter-consumer dependencies remain pending |
