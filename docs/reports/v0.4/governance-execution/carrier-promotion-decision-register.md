...
|------|------|------|------|------|------|------|------|------|------|------|
| `CPR-001` | Workspace topology carrier promotion | [PR-0403 workspace-topology workflow](PR-0403/workspace-topology-carrier-promotion-workflow.md) | `OI-031` through `OI-050` | `blocked_pending_landing` | Current published carriers remain consistent because DI-15/16/17/18 families are still kept out of mainline publication; `PR-0408` and `PR-0409` are now landed in the workflow ledger, but promotion remains blocked pending the remaining workspace chain. | `PR-0410` through `PR-0413` landed, workflow ledger rows updated, and PR-0404/PR-0405 closeout confirms the promotion gate | `PR-0410` through `PR-0413`, then governance audit | carry forward unless every required workflow row is landed before PR-0405 closeout | default `PR-0405` | Covers DI-15 active bundles plus DI-16/17/18 supporting bundles |
